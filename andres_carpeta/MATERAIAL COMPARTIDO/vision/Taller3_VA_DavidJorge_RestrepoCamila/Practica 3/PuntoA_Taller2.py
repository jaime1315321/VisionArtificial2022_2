...
img1 = cv2.imread('cerebro.png', 0)  # Leemos la imagen deseada
...
imgb = cv2.GaussianBlur(img1, (35, 35), sigmaX=10, sigmaY=0)  # Aplicamos el S a la imagen con la funcion filter2D
